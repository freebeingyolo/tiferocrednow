...
class EditDialog : BasePopupWindow, View.OnClickListener {
    ...
    var title: String
        set(value) = run { tvTitle.text = value }
        get() = tvTitle.text.toString()
    var hint: String
        set(value) = run { tvHint.text = value }
        get() = tvHint.text.toString()
    var leftBtnText: String
        set(value) = run { tvLeft.text = value }
        get() = tvLeft.text.toString()
    var rightBtnText: String
        set(value) = run { tvRight.text = value }
        get() = tvRight.text.toString()
    var inputType: Int
        set(value) = run { etContent.inputType = value }
        get() = etContent.inputType
    var content: String
        set(value) = run { etContent.setText(value) }
